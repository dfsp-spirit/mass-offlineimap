...
while read -r line || [[ -n "$line" ]]; do
    ...
    # Add general and account information
	echo "[general]" >> "$FILE_USER_OFFLINEIMAP_CONF"
    echo "accounts = mass-offlineimap-${ACCOUNT_NAME}" >> "$FILE_USER_OFFLINEIMAP_CONF"
    echo "maxsyncaccounts = 1"  >> "$FILE_USER_OFFLINEIMAP_CONF"
	echo '' >> "$FILE_USER_OFFLINEIMAP_CONF"
